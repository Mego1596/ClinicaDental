...
<div class="table-responsive">
	<table width="100%">
		<tr>
			...
			@if(sizeof($cita->receta->detalle_receta) < 2) <td width="10%" align="right">
				@can('receta.create')
				<button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#crearRecetaDetalle">
					<i class="fa  fa-list"></i> Asignar Detalles
				</button>
				<!-- Modal -->
				...
				<td width="10%" align="right">
					...
					<button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editarReceta">
						<i class="fa fa-pencil-alt"></i> Editar Receta
					</button>
					@endcan
				</td>
				<td width="10%" align="right">
					...
					<button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-default-eliminar-receta">
						<i class="fa fa-trash"></i> Eliminar Receta
					</button>
					@endcan
				</td>
				@else
		...
		<div class="table-responsive">
			<table class="display table-hovered table-striped" width="100%">
				...
				<tr>
					...
					<td width="25%">
						@can('receta.edit')
						<button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#modalEditDetalle" onclick="selectDetalle({{$cita->receta->id}},{{ $detalle->id }},'{{ $detalle->medicamento }}','{{ $detalle->dosis }}','{{ $detalle->cantidad }}');" title="Detalles de la receta"><i class="fa fa-pencil-alt"></i> Editar</button>
						@endcan
						@can('receta.destroy')
		...
		<tr>
			...
			<td width="20%" align="right">
				...
				<button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#crearReceta" style="color: black">
					<i class="fa  fa-list"></i> Registrar Receta
				</button>
				@endcan
			</td>
		</tr>
