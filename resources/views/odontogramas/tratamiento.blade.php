...
<body>
	<div>
		<div id="barra_inicial" align="center">
			<i class="fa fa-tooth" style="color: white;margin-top: 0.5%;font-size: 40px"></i> Odontograma de:{{$cita->persona->primer_nombre." ".$cita->persona->segundo_nombre." ".$cita->persona->primer_apellido." ".$cita->segundo_apellido}}
		</div>
		<div align="center">
			<table width="100%">
				<tr>
				...
				<tr>
					...
					<td align="center"><a href="{{route('expedientes.planes',['persona' => $cita->persona->id])}}"><button style="width: 80px;height: 70px"><i class="fa fa-arrow-circle-left"></i> Regresar</button> </a></td>
				</tr>
			</table>
		</div>
		<div align="center">
