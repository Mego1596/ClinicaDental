...
<body>
	<div>
		<div id="barra_inicial" align="center">
			<i class="fas fa-tooth" style="color: white;margin-top: 0.5%;font-size: 40px"></i> Odontograma de:{{$cita->persona->primer_nombre." ".$cita->persona->segundo_nombre." ".$cita->persona->primer_apellido." ".$cita->segundo_apellido}}
		</div>
		<div align="center">
			<table width="100%">
				<tr>
