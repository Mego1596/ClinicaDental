							...
							<td>
								<div class="modal-footer">
									...
									<button type="button" class="btn btn-outline-danger" onclick="$('#eliminarCita').modal('show').on('shown.bs.modal',function(e){  });">
										<i class="fa fa-trash"></i> Eliminar Cita
									</button>
									@endcan
								</div>
							</td>
		...
		<div class="modal-content">
			...
			<form id="form_reprogramar" method="POST" action="">
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-success"><i class="fa fa-calendar-check"></i> Reprogramar</button>
				</div>
			</form>
		</div>
	</div>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<form id="form_eliminar" method="POST" action="">
					@csrf
					{{method_field('DELETE')}}
					<button type="submit" class="btn btn-success"><i class="fa fa-trash"></i> Eliminar</button>
				</form>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	$(function() {
		...
		$('#numero_expediente').mask('X000-0000', {
			translation: {
				'X': {
					pattern: /([A-Z])/,
					optional: false
