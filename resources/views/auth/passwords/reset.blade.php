                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4" align="justify">Estas a punto de finalizar, completa el formulario ubicado en la parte de abajo para finalizar el proceso de restauracion de tu contraseña.</p>
                                    </div>
                                    <form method="POST" action="{{ route('password.update') }}">
                                        ...
                                        <div class="form-group" align="center">
                                            <a href="{{route('login')}}" class="btn btn-secondary" style="display: inline-block;"><i class="fa fa-arrow-circle-left"></i> Regresar</a>
