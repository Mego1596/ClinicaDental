    ...
    <table width="100%">
        <tr>
            ...
            <td width="20%" align="right">
                @can('role.create')
                <a href="{{route('roles.create')}}" class="btn btn-sm btn-success" style="color: black"><i class="fa  fa-list"></i> Registrar Rol</a>
                @endcan
            </td>
        </tr>
    </table>
        ...
        <table id="example" class="display" style="width:100%;color: black">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @can('role.show')
                        <a href="{{route('roles.show',['role' => $rol->id])}}" class="btn btn-info btn-circle" title="Ver perfil"><i class="fa fa-eye"></i></a>
                        @endcan
                        @can('role.edit')
                        <a class="btn btn-primary btn-circle" href="{{route('roles.edit', ['role' => $rol->id])}}"><i class="fa  fa-pencil-alt"></i></a>
                        @endcan
                        @can('role.destroy')
