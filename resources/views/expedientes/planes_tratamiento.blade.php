...
<div class="table-responsive">
    <table width="100%">
        <tr>
            <td width="100%">
                <a class="btn btn-sm btn-danger" href="{{route('expedientes.index')}}"><i class="fa fa-arrow-circle-left"></i> Regresar</a>
            </td>
        </tr>
    </table>
</div>
        ...
        <table class="table table-bordered" id="example" width="100%" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="{{ route('expedientes.plan',['cita' => $cita->id])}}" class="btn btn-sm btn-info" style="color: white" target="_blank">
                            <li class="fa fa-file-pdf-o"></li> Ver Plan de Tratamiento
                    </td>
                    <td align="center">
                        @if($loop->last)
                        @if(sizeof($cita->odontogramas) == 0)
                        @can('odontograma.create')
                        <a href="{{ route('odontogramas.tratamiento',['cita' => $cita->id])}}" class="btn btn-circle btn-primary" style="color: white">
