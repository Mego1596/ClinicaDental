function addProcedimiento(procedimientos,nuevo = 0){
    ...
    if ($(form+'#procedimientos_create').is(':empty')) {
        ...
        html_code=html_code
        		...
        		+"</div>"
                +"<div class='col-sm-4'>"
                    +"<input id='input_1_"+numero_select+"' type='number' step='1' min='0' max='32' value='0' name='procedimiento["+numero_select+"][numero_piezas]' class='form-control' placeholder='Numero de piezas' required />"
                +"</div>"
                +"<div class='col-sm-4'>"
                    +"<input id='input_2_"+numero_select+"' type='number' step='0.01' min='0' value='0.00' name='procedimiento["+numero_select+"][honorarios]' class='form-control' placeholder='Honorarios' required />"
                +"</div>"
